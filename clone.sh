...
REPOS=$HOME/Documents/Programming/Repos
#BLADE=$REPOS/blade-ui-kit
#LARAVEL=$REPOS/laravel

# Personal
git clone git@github.com:Leamsi9/laravel-rapid.git $REPOS/laravel-rapid
git clone git@github.com:Leamsi9/laravel-rapid.git $REPOS/laravel-rapid

# Baha'i Library
git clone git@github.com:BahaiLibraryOnline/bahai-library-online-laravel.git $REPOS/BahaiLibraryOnline
git clone git@github.com:BahaiLibraryOnline/working-legacy.git $REPOS/BahaiLibraryOnline
git clone git@github.com:BahaiLibraryOnline/https://github.com/BahaiLibraryOnline/Bahai-Library-API.git $REPOS/BahaiLibraryOnline
